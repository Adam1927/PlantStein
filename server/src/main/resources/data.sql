...
insert into Species (name, perfect_temperature, perfect_light, perfect_humidity, homeland, botanical_name, bloom_time, max_height)
 values ('Jade Plant', 24, 16000, 45, 'South Africa', 'Crassula Ovata', 'Spring', 152.4);
insert into Species (name, perfect_temperature, perfect_light, perfect_humidity, homeland, botanical_name, bloom_time, max_height)
...
insert into Species (name, perfect_temperature, perfect_light, perfect_humidity, homeland, botanical_name, bloom_time, max_height)
 values ('Rubber Plant', 20, 16000, 60, 'Asia', 'Ficus elastica', 'Varies, rarely blooms', 304.8);
insert into Species (name, perfect_temperature, perfect_light, perfect_humidity, homeland, botanical_name, bloom_time, max_height)
 values ('Zebra Plant', 21, 12000, 65, 'Brazil', 'Aphelandra squarrosa', 'Summer, Fall', 182.9);
